<template>
  ...
  <div class='entire-container'>
    ...
    <div class='container-menu'>
      ...
      <!-- This is the beginning of the title bar of the maximized window; 
      does not show when there are more than one windows in the scene.
      If this title bar is absent (IF noOfPanels != 1), then the title bar 
      shows up on the individual windows-->
      <div v-if="noOfPanels == 1">
        <div
          v-for='(panel, name) in panels'
          v-bind:key='panel.name'
          v-bind:id='panel.id'
          v-show='panel.active'
          style='border-radius: 8px !important; border-bottom-left-radius: 0px !important;border-bottom-right-radius: 0px !important;'
        >
          <div class='card__header pastel-background' style='border-radius: 8px !important; border-bottom-left-radius: 0px !important;border-bottom-right-radius: 0px !important;'>
      ...
      <!-- end of title bar for maximized window -->
      <div>
    ...
    >
      <div
        ...
        class='card'
      >
        <div v-if='noOfPanels != 1' class='card__header pastel-background'>
          <div class='card__header-title' v-html="panel.title"></div>
          <div>
            <span v-if='noOfPanels > 1' title='Expand panel' v-on:click='expandPanel(name)'>
            <!-- <i class='fas fa-maximize card-menu-button__on'></i> -->
            <!-- <i class="fa-regular fa-square-plus card-menu-button__on"></i> -->
            <i class="fas fa-plus card-menu-button__on"></i>
...
localPanels['Atlas'] = {
  ...
  buttonContent: '<i class="fas fa-diagram-project"></i>',
  active: false,
  order: 3,
}

import notepadComponent from  './pieces/exploreNotepad.vue'
localPanels['Notebook'] = {
    name: 'Notebook',
    title: '<strong>Once</strong> Upon a Time ...',
    id: 'panelNotebook',
    buttonContent: '<i class="fas fa-pen-to-square"></i>',
    active: false,
    order: 2,
}
...
export default {
  ...
  mounted() {
    ...
    this.gridDirectives = localGridDirectives;
    this.updatePanels();
